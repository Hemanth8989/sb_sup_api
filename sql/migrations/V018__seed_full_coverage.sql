-- ============================================================
-- V018: Full seed-data expansion â€” all tenants, all page tabs
--
-- New tenants:
--   66666666-â€¦ fab3  Mountain View Countertops
--   77777777-â€¦ fab4  Prestige Stone Works
--
...
--   Products   cc000008â€“cc000013 (slab), cc100001â€“cc100003 (sup2 supply),
--              cc200001â€“cc200003 (sup3 supply)
--   Variants   dd000009â€“dd000014 (slab), vr100001â€“vr100004 (sup2),
--              vr200001â€“vr200003 (sup3)
--   Slabs sup1 ee070001â€“ee070004 (Statuario), ee080001â€“ee080003 (Nero Marquina),
--              ee090001â€“ee090002 (extra sold/allocated)
--   Slabs sup2 ee0a0001â€“ee0a0003 (Azul Macauba), ee0b0001â€“ee0b0002 (White Macauba new)
--   Slabs sup3 ee0c0001â€“ee0c0003 (Black Galaxy), ee0d0001â€“ee0d0002 (Colonial White new)
--   Price lists pl000003 (sup1 vip), pl100001â€“pl100002 (sup2), pl200001â€“pl200002 (sup3)
--   Connections ff000005â€“ff000009
--   Addresses  ad000004â€“ad000005
--   Jobs       jb000003â€“jb000005
--   POs        po000003â€“po000009
--   PO lines   li000003â€“li000014
-- ============================================================

SET row_security = OFF;
-- Missing product categories referenced by this seed
INSERT INTO product_categories (code, label, sort_order) VALUES
    ('polishing_compound', 'Polishing Compound', 23)
...
-- â”€â”€ Sup1: Statuario Marble + Nero Marquina â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
-- â”€â”€ Sup2: Azul Macauba + White Macauba Quartzite â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
INSERT INTO products (id, tenant_id, category_code, name, brand, short_description, is_active, created_at, updated_at) VALUES
...
-- â”€â”€ Sup3: Black Galaxy Granite + Colonial White Granite â”€â”€â”€â”€â”€â”€â”€
INSERT INTO products (id, tenant_id, category_code, name, brand, short_description, is_active, created_at, updated_at) VALUES
...
-- â”€â”€ Slab variants â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
-- â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•
-- 3. NEW SLABS â€” MARBLE MASTERS (sup1) covering all statuses
-- â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•

-- Statuario (dd000009) â€” available (2) + allocated (2) + hold (1)
INSERT INTO slabs (
...
-- Nero Marquina (dd000010) â€” available (2) + shipped (2) + sold (2)
INSERT INTO slabs (
    id, variant_id, tenant_id, internal_ref,
    material_type, material_name, color_family, pattern,
    origin_country, quarry_name, lot_number, block_number,
...
-- â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•
-- 4. NEW SLABS â€” STONE SOURCE (sup2)
-- â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•

-- Azul Macauba (dd000011) â€” available + reserved + hold
INSERT INTO slabs (
    id, variant_id, tenant_id, internal_ref,
    material_type, material_name, color_family, pattern,
    origin_country, quarry_name, lot_number, block_number,
...
-- White Macauba (dd000012) â€” available + shipped + sold
INSERT INTO slabs (
    id, variant_id, tenant_id, internal_ref,
    material_type, material_name, color_family, pattern,
    origin_country, quarry_name, lot_number, block_number,
...
UPDATE slabs
SET    status         = 'reserved',
       reserved_for_po = 'c0000008-0000-0000-0000-000000000000',
       status_changed  = NOW() - INTERVAL '1 week',
       updated_at      = NOW() - INTERVAL '1 week'
WHERE  id = 'ee030001-0000-0000-0000-000000000000';

-- â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•
-- 5. NEW SLABS â€” PREMIER GRANITE (sup3)
-- â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•

-- Black Galaxy (dd000013) â€” available + allocated + sold
INSERT INTO slabs (
    id, variant_id, tenant_id, internal_ref,
    material_type, material_name, color_family, pattern,
    origin_country, quarry_name, lot_number, block_number,
    ...
    ('ee0c0001-0000-0000-0000-000000000000', 'dd000013-0000-0000-0000-000000000000', '33333333-3333-3333-3333-333333333333',
     'BG3P-001', 'granite', 'Black Galaxy', 'black', 'flecked', 'IN', 'Andhra Pradesh Quarry', 'LOT-2026-0088', 'BLK-BG-01',
    ...
    ('ee0c0002-0000-0000-0000-000000000000', 'dd000013-0000-0000-0000-000000000000', '33333333-3333-3333-3333-333333333333',
     'BG3P-002', 'granite', 'Black Galaxy', 'black', 'flecked', 'IN', 'Andhra Pradesh Quarry', 'LOT-2026-0088', 'BLK-BG-01',
    ...
    ('ee0c0003-0000-0000-0000-000000000000', 'dd000013-0000-0000-0000-000000000000', '33333333-3333-3333-3333-333333333333',
     'BG3P-003', 'granite', 'Black Galaxy', 'black', 'flecked', 'IN', 'Andhra Pradesh Quarry', 'LOT-2026-0088', 'BLK-BG-02',
    ...
    ('ee0c0004-0000-0000-0000-000000000000', 'dd000013-0000-0000-0000-000000000000', '33333333-3333-3333-3333-333333333333',
     'BG3P-004', 'granite', 'Black Galaxy', 'black', 'flecked', 'IN', 'Andhra Pradesh Quarry', 'LOT-2025-0700', 'BLK-BG-03',
    ...
    ('ee0c0005-0000-0000-0000-000000000000', 'dd000013-0000-0000-0000-000000000000', '33333333-3333-3333-3333-333333333333',
     'BG3P-005', 'granite', 'Black Galaxy', 'black', 'flecked', 'IN', 'Andhra Pradesh Quarry', 'LOT-2025-0600', 'BLK-BG-04',
...
-- Colonial White (dd000014) â€” available + hold + reserved
INSERT INTO slabs (
    id, variant_id, tenant_id, internal_ref,
    material_type, material_name, color_family, pattern,
    origin_country, quarry_name, lot_number, block_number,
...
-- â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•
-- 6. NON-SLAB PRODUCTS â€” STONE SOURCE (sup2)
-- â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•
...
INSERT INTO product_variants (
    ...
    ('0e100001-0000-0000-0000-000000000000',
     'cc100001-0000-0000-0000-000000000000', '22222222-2222-2222-2222-222222222222',
    ...
    ('0e100002-0000-0000-0000-000000000000',
     'cc100002-0000-0000-0000-000000000000', '22222222-2222-2222-2222-222222222222',
    ...
    ('0e100003-0000-0000-0000-000000000000',
     'cc100002-0000-0000-0000-000000000000', '22222222-2222-2222-2222-222222222222',
    ...
    ('0e100004-0000-0000-0000-000000000000',
     'cc100003-0000-0000-0000-000000000000', '22222222-2222-2222-2222-222222222222',
...
-- â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•
-- 7. NON-SLAB PRODUCTS â€” PREMIER GRANITE (sup3)
-- â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•
...
INSERT INTO product_variants (
    ...
    ('0e200001-0000-0000-0000-000000000000',
     'cc200001-0000-0000-0000-000000000000', '33333333-3333-3333-3333-333333333333',
    ...
    ('0e200002-0000-0000-0000-000000000000',
     'cc200002-0000-0000-0000-000000000000', '33333333-3333-3333-3333-333333333333',
    ...
    ('0e200003-0000-0000-0000-000000000000',
     'cc200003-0000-0000-0000-000000000000', '33333333-3333-3333-3333-333333333333',
...
INSERT INTO price_list_items (id, price_list_id, variant_id, unit_price, currency, created_at) VALUES
    ('0a000009-0000-0000-0000-000000000000',  'f0000003-0000-0000-0000-000000000000', 'dd000001-0000-0000-0000-000000000000', 23.00, 'USD', NOW() - INTERVAL '2 months'),
    ('0a000010-0000-0000-0000-000000000000',  'f0000003-0000-0000-0000-000000000000', 'dd000002-0000-0000-0000-000000000000', 18.00, 'USD', NOW() - INTERVAL '2 months'),
    ('0a000011-0000-0000-0000-000000000000',  'f0000003-0000-0000-0000-000000000000', 'dd000003-0000-0000-0000-000000000000', 70.00, 'USD', NOW() - INTERVAL '2 months'),
    ('0a000012-0000-0000-0000-000000000000',  'f0000003-0000-0000-0000-000000000000', 'dd000004-0000-0000-0000-000000000000', 26.00, 'USD', NOW() - INTERVAL '2 months'),
    ('0a000013-0000-0000-0000-000000000000',  'f0000003-0000-0000-0000-000000000000', 'dd000009-0000-0000-0000-000000000000', 118.00,'USD', NOW() - INTERVAL '2 months'),
    ('0a000014-0000-0000-0000-000000000000',  'f0000003-0000-0000-0000-000000000000', 'dd000010-0000-0000-0000-000000000000', 62.00, 'USD', NOW() - INTERVAL '2 months');

-- Sup2: standard + preferred
INSERT INTO price_lists (id, tenant_id, name, tier, currency, is_active, created_at, updated_at) VALUES
    ('f0100001-0000-0000-0000-000000000000',
     '22222222-2222-2222-2222-222222222222',
     'Stone Source Standard 2026', 'standard', 'USD', TRUE,
     NOW() - INTERVAL '4 months', NOW()),

    ('f0100002-0000-0000-0000-000000000000',
     '22222222-2222-2222-2222-222222222222',
...
INSERT INTO price_list_items (id, price_list_id, variant_id, unit_price, currency, created_at) VALUES
    -- Standard
    ('0a100001-0000-0000-0000-000000000000', 'f0100001-0000-0000-0000-000000000000', 'dd000005-0000-0000-0000-000000000000', 145.00, 'USD', NOW() - INTERVAL '4 months'),
    ('0a100002-0000-0000-0000-000000000000', 'f0100001-0000-0000-0000-000000000000', 'dd000006-0000-0000-0000-000000000000', 68.00,  'USD', NOW() - INTERVAL '4 months'),
    ('0a100003-0000-0000-0000-000000000000', 'f0100001-0000-0000-0000-000000000000', 'dd000011-0000-0000-0000-000000000000', 195.00, 'USD', NOW() - INTERVAL '4 months'),
    ('0a100004-0000-0000-0000-000000000000', 'f0100001-0000-0000-0000-000000000000', 'dd000012-0000-0000-0000-000000000000', 88.00,  'USD', NOW() - INTERVAL '4 months'),
    -- Preferred (â‰ˆ10% off)
    ('0a100005-0000-0000-0000-000000000000', 'f0100002-0000-0000-0000-000000000000', 'dd000005-0000-0000-0000-000000000000', 130.00, 'USD', NOW() - INTERVAL '4 months'),
    ('0a100006-0000-0000-0000-000000000000', 'f0100002-0000-0000-0000-000000000000', 'dd000006-0000-0000-0000-000000000000', 61.00,  'USD', NOW() - INTERVAL '4 months'),
    ('0a100007-0000-0000-0000-000000000000', 'f0100002-0000-0000-0000-000000000000', 'dd000011-0000-0000-0000-000000000000', 175.00, 'USD', NOW() - INTERVAL '4 months'),
    ('0a100008-0000-0000-0000-000000000000', 'f0100002-0000-0000-0000-000000000000', 'dd000012-0000-0000-0000-000000000000', 79.00,  'USD', NOW() - INTERVAL '4 months');

-- Sup3: standard + vip
INSERT INTO price_lists (id, tenant_id, name, tier, currency, is_active, created_at, updated_at) VALUES
    ('f0200001-0000-0000-0000-000000000000',
     '33333333-3333-3333-3333-333333333333',
     'Premier Granite Standard 2026', 'standard', 'USD', TRUE,
     NOW() - INTERVAL '6 months', NOW()),

    ('f0200002-0000-0000-0000-000000000000',
     '33333333-3333-3333-3333-333333333333',
...
INSERT INTO price_list_items (id, price_list_id, variant_id, unit_price, currency, created_at) VALUES
    -- Standard
    ('0a200001-0000-0000-0000-000000000000', 'f0200001-0000-0000-0000-000000000000', 'dd000007-0000-0000-0000-000000000000', 18.50, 'USD', NOW() - INTERVAL '6 months'),
    ('0a200002-0000-0000-0000-000000000000', 'f0200001-0000-0000-0000-000000000000', 'dd000008-0000-0000-0000-000000000000', 16.00, 'USD', NOW() - INTERVAL '6 months'),
    ('0a200003-0000-0000-0000-000000000000', 'f0200001-0000-0000-0000-000000000000', 'dd000013-0000-0000-0000-000000000000', 24.00, 'USD', NOW() - INTERVAL '6 months'),
    ('0a200004-0000-0000-0000-000000000000', 'f0200001-0000-0000-0000-000000000000', 'dd000014-0000-0000-0000-000000000000', 14.00, 'USD', NOW() - INTERVAL '6 months'),
    -- VIP (â‰ˆ15% off)
    ('0a200005-0000-0000-0000-000000000000', 'f0200002-0000-0000-0000-000000000000', 'dd000007-0000-0000-0000-000000000000', 15.75, 'USD', NOW() - INTERVAL '6 months'),
    ('0a200006-0000-0000-0000-000000000000', 'f0200002-0000-0000-0000-000000000000', 'dd000008-0000-0000-0000-000000000000', 13.50, 'USD', NOW() - INTERVAL '6 months'),
    ('0a200007-0000-0000-0000-000000000000', 'f0200002-0000-0000-0000-000000000000', 'dd000013-0000-0000-0000-000000000000', 20.00, 'USD', NOW() - INTERVAL '6 months'),
    ('0a200008-0000-0000-0000-000000000000', 'f0200002-0000-0000-0000-000000000000', 'dd000014-0000-0000-0000-000000000000', 11.75, 'USD', NOW() - INTERVAL '6 months');

-- â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•
-- 9. CONNECTIONS â€” cover all statuses for sup1 + link new tenants
-- â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•
...
INSERT INTO connections (
    ...
    -- fab1 â†” sup3: active standard â€” Countertop Kings expands to Premier Granite
    ...
    -- fab2 â†” sup2: active preferred â€” Elite Surfaces sources exotic quartzite from Stone Source
    ...
    -- fab3 (Mountain View) â†” sup1: PENDING â€” new shop requesting access to Marble Masters
    ...
    -- fab4 (Prestige Stone Works) â†” sup1: SUSPENDED â€” was active, now suspended for late payment
    ...
    -- fab4 (Prestige) â†” sup3: active vip â€” large shop gets VIP with Premier Granite
...
INSERT INTO connection_history (id, connection_id, from_status, to_status, changed_by, reason, changed_at) VALUES
    ...
    ('cf000007-0000-0000-0000-000000000000', 'ff000008-0000-0000-0000-000000000000', 'active',  'suspended', 'aa000001-0000-0000-0000-000000000000', 'Account past due â€” 60+ days.', NOW() - INTERVAL '2 weeks'),
...
INSERT INTO connection_price_lists (id, connection_id, price_list_id, assigned_by, assigned_at) VALUES
    ('0c000003-0000-0000-0000-000000000000', 'ff000005-0000-0000-0000-000000000000', 'f0200001-0000-0000-0000-000000000000', 'aa000003-0000-0000-0000-000000000000', NOW() - INTERVAL '3 months'),
    ('0c000004-0000-0000-0000-000000000000', 'ff000006-0000-0000-0000-000000000000', 'f0100002-0000-0000-0000-000000000000', 'aa000002-0000-0000-0000-000000000000', NOW() - INTERVAL '5 weeks'),
    ('0c000005-0000-0000-0000-000000000000', 'ff000009-0000-0000-0000-000000000000', 'f0200002-0000-0000-0000-000000000000', 'aa000003-0000-0000-0000-000000000000', NOW() - INTERVAL '3 months');

-- â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•
-- 10. JOBS â€” fill out fab2, fab3, fab4
-- â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•
...
INSERT INTO jobs (
    ...
    ('0b000003-0000-0000-0000-000000000000',
     ...
     12000.00,
     'Full Blue Bahia waterfall island + perimeter Calacatta. Very high-end project â€” handle with care.',
    ...
    ('0b000005-0000-0000-0000-000000000000',
     ...
     'approved', '2026-07-02', '2026-07-10', '2026-07-15',
     2800.00,
...
-- â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•
-- 11. PURCHASE ORDERS â€” cover all status tabs for sup1,
--     plus POs for sup2 and sup3
-- â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•

-- PO-2026-000003: fab1â†’sup1, ACKNOWLEDGED
--   2 Statuario slabs (ee070003, ee070004) â†’ 65 sqft each Ã— $135
...
-- PO-2026-000004: fab2â†’sup1, SHIPPED
--   Nero Marquina NM3P-003 and NM3P-004 â†’ ~50 sqft each Ã— $72
INSERT INTO purchase_orders (
    id, po_number, fabricator_id, supplier_id, job_id,
    status, status_changed,
    subtotal, total_amount, currency,
    ...
    'Nero Marquina for Williams Kitchen island â€” both slabs from same lot please.',
...
-- PO-2026-000005: fab1â†’sup1, RECEIVED
--   Calacatta Gold CAL3P-002 â†’ 55 sqft Ã— $85
INSERT INTO purchase_orders (
    id, po_number, fabricator_id, supplier_id, job_id,
    status, status_changed,
    subtotal, total_amount, currency,
...
-- PO-2026-000006: fab1â†’sup1, CANCELLED
INSERT INTO purchase_orders (
    ...
    'Carrara White order for Lakeview job. Client changed to engineered stone â€” cancelling.',
    NOW() - INTERVAL '7 weeks',
    'aa000004-0000-0000-0000-000000000000',
    NOW() - INTERVAL '7 weeks', NOW()
);

-- PO-2026-000007: fab3(Mountain View)â†’sup1, SENT â€” first PO from the new fab
INSERT INTO purchase_orders (
    id, po_number, fabricator_id, supplier_id, job_id,
    status, status_changed,
    subtotal, total_amount, currency,
...
-- PO-2026-000008: fab1â†’sup2 (Stone Source), SENT
INSERT INTO purchase_orders (
    id, po_number, fabricator_id, supplier_id, job_id,
    status, status_changed,
    subtotal, total_amount, currency,
    ...
    'Blue Bahia for a designer spec project. Lot AA-3X preferred â€” already saw it in the yard.',
    NOW() - INTERVAL '1 week',
    'aa000004-0000-0000-0000-000000000000',
    NOW() - INTERVAL '1 week', NOW()
);

-- PO-2026-000009: fab2â†’sup3 (Premier Granite), RECEIVED
INSERT INTO purchase_orders (
    id, po_number, fabricator_id, supplier_id, job_id,
    status, status_changed,
    subtotal, total_amount, currency,
...
-- â”€â”€ PO status history â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
INSERT INTO po_status_history (id, po_id, from_status, to_status, changed_by, note, changed_at) VALUES
    ('e0000002-0000-0000-0000-000000000000', 'c0000003-0000-0000-0000-000000000000', 'draft', 'sent',         'aa000004-0000-0000-0000-000000000000', NULL,                          NOW() - INTERVAL '12 days'),
    ('e0000003-0000-0000-0000-000000000000', 'c0000003-0000-0000-0000-000000000000', 'sent',  'acknowledged', 'aa000001-0000-0000-0000-000000000000', 'Slabs allocated and ready.',  NOW() - INTERVAL '10 days'),
    ('e0000004-0000-0000-0000-000000000000', 'c0000004-0000-0000-0000-000000000000', 'draft', 'sent',         'aa000005-0000-0000-0000-000000000000', NULL,                          NOW() - INTERVAL '20 days'),
    ('e0000005-0000-0000-0000-000000000000', 'c0000004-0000-0000-0000-000000000000', 'sent',  'acknowledged', 'aa000001-0000-0000-0000-000000000000', 'Confirmed lot match.',        NOW() - INTERVAL '18 days'),
    ('e0000006-0000-0000-0000-000000000000', 'c0000004-0000-0000-0000-000000000000', 'acknowledged', 'shipped', 'aa000001-0000-0000-0000-000000000000', 'Shipped on pallet via XPO.', NOW() - INTERVAL '14 days'),
    ('e0000007-0000-0000-0000-000000000000', 'c0000005-0000-0000-0000-000000000000', 'draft', 'sent',         'aa000004-0000-0000-0000-000000000000', NULL,                          NOW() - INTERVAL '45 days'),
    ('e0000008-0000-0000-0000-000000000000', 'c0000005-0000-0000-0000-000000000000', 'sent',  'acknowledged', 'aa000001-0000-0000-0000-000000000000', NULL,                          NOW() - INTERVAL '43 days'),
    ('e0000009-0000-0000-0000-000000000000', 'c0000005-0000-0000-0000-000000000000', 'acknowledged', 'shipped', 'aa000001-0000-0000-0000-000000000000', NULL,                        NOW() - INTERVAL '38 days'),
    ('e0000010-0000-0000-0000-000000000000', 'c0000005-0000-0000-0000-000000000000', 'shipped', 'received',   'aa000004-0000-0000-0000-000000000000', 'Received in good condition.', NOW() - INTERVAL '30 days'),
    ('e0000011-0000-0000-0000-000000000000', 'c0000006-0000-0000-0000-000000000000', 'draft', 'sent',         'aa000004-0000-0000-0000-000000000000', NULL,                          NOW() - INTERVAL '7 weeks'),
    ('e0000012-0000-0000-0000-000000000000', 'c0000006-0000-0000-0000-000000000000', 'sent',  'cancelled',    'aa000004-0000-0000-0000-000000000000', 'Client switched to quartz.',  NOW() - INTERVAL '6 weeks'),
    ('e0000013-0000-0000-0000-000000000000', 'c0000007-0000-0000-0000-000000000000', 'draft', 'sent',         'aa000006-0000-0000-0000-000000000000', NULL,                          NOW() - INTERVAL '2 days'),
    ('e0000014-0000-0000-0000-000000000000', 'c0000008-0000-0000-0000-000000000000', 'draft', 'sent',         'aa000004-0000-0000-0000-000000000000', NULL,                          NOW() - INTERVAL '1 week'),
    ('e0000015-0000-0000-0000-000000000000', 'c0000009-0000-0000-0000-000000000000', 'draft', 'sent',         'aa000005-0000-0000-0000-000000000000', NULL,                          NOW() - INTERVAL '5 weeks'),
    ('e0000016-0000-0000-0000-000000000000', 'c0000009-0000-0000-0000-000000000000', 'sent',  'acknowledged', 'aa000003-0000-0000-0000-000000000000', NULL,                          NOW() - INTERVAL '4 weeks' + INTERVAL '2 days'),
    ('e0000017-0000-0000-0000-000000000000', 'c0000009-0000-0000-0000-000000000000', 'acknowledged', 'shipped', 'aa000003-0000-0000-0000-000000000000', NULL,                        NOW() - INTERVAL '3 weeks'),
    ('e0000018-0000-0000-0000-000000000000', 'c0000009-0000-0000-0000-000000000000', 'shipped', 'received',   'aa000005-0000-0000-0000-000000000000', 'All slabs received, no damage.', NOW() - INTERVAL '20 days');

-- â”€â”€ PO Line items â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
(
    ...
    100.00, 'sqft', 28.50, 2850.00, 'USD', 'declined', NOW() - INTERVAL '7 weeks', NOW()
);
...
-- â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•
-- 12. SLAB STATUS UPDATES â€” sync with PO state
-- â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•

-- po000003 (acknowledged) â†’ slabs become allocated
UPDATE slabs
SET    status         = 'allocated',
       reserved_for_po = 'c0000003-0000-0000-0000-000000000000',
...
-- po000004 (shipped) â†’ slabs are shipped (already set to 'shipped' in INSERT above)
UPDATE slabs
SET    reserved_for_po = 'c0000004-0000-0000-0000-000000000000',
...
-- po000005 (received) â†’ Calacatta Gold slab sold
UPDATE slabs
SET    status          = 'sold',
       is_active       = FALSE,
       reserved_for_po = 'c0000005-0000-0000-0000-000000000000',
       status_changed  = NOW() - INTERVAL '30 days',
       updated_at      = NOW() - INTERVAL '30 days'
WHERE  id = 'ee010002-0000-0000-0000-000000000000';

-- po000009 (received) â†’ Black Galaxy slabs for Premier Granite sold
UPDATE slabs
SET    status          = 'sold',
       is_active       = FALSE,
       reserved_for_po = 'c0000009-0000-0000-0000-000000000000',
